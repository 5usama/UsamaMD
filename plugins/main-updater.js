...
cmd({
    ...
    try {
        await reply("🔍 Checking for UsamaMD updates...");

        // Fetch the latest commit hash from GitHub
        const { data: commitData } = await axios.get("https://api.github.com/repos/5usama/UsamaMD/commits/main");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your UsamaMD bot is already up-to-date!");
        }

        await reply("🚀 Updating UsamaMD Bot...");
        ...
        const sourcePath = path.join(extractPath, "UsamaMD-main");
