...
const ownerNumber = ['923239601585'];
...
let conn; // Global connection object
...
app.get("/", (req, res) => {
    res.send("UsamaMD Connection Successfull ✅");
});
